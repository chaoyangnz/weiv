...
var _mobx = __webpack_require__(113);
...
var App = exports.App = (_dec = (0, _component.Component)({
  ...
  return App;
}(), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'counter', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return 10;
  }
}), _applyDecoratedDescriptor(_class2.prototype, 'countdown', [_mobx.action], Object.getOwnPropertyDescriptor(_class2.prototype, 'countdown'), _class2.prototype)), _class2)) || _class);


var app = new App();
_weiv2.default.mount(app);
...
var _vdomParser = __webpack_require__(114);
...
function createMeta(options) {
  ...
  meta.$render = function () {
    if (this.$template) {
      ...
      var vdom = (0, _vdomParser2.default)(html); // convert HTML to VDOM
      if (Array.isArray(vdom)) {
        throw new Error('Template only supports single root.');
      }
      this.$vdom = vdom;
    } else {
      this.vdom = (0, _virtualDom.h)('div', {}, []);
    }
  };
...
var Weiv = {
  ...
  mount: function mount(component) {
    ...
    (0, _mobx.autorun)(function () {
      var vdom = component.$vdom; // old vdom tree
      component.$render();
      if (vdom) {
        var patches = _virtualDom2.default.diff(vdom, component.$vdom);
        console.log('%o', patches);
        component.$dom = _virtualDom2.default.patch(component.$dom, patches);
      } else {
        var dom = _virtualDom2.default.create(component.$vdom);
        component.$dom = dom;
...
var propertyMap = __webpack_require__(115);
var namespaceMap = __webpack_require__(116);
